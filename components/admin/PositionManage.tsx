...
import { approveRight } from "../../assets/data";
      ...
      <View style={styles.infoContainer}>
        <DataTable>
          <DataTable.Header>
            ...
            <DataTable.Title>Quyền duyệt</DataTable.Title>
            <DataTable.Title
              style={{
                alignItems: "center",
          ...
          {userList ? (
            <FlatList
              ...
              renderItem={({ item }) => (
                <DataTable.Row>
                  <DataTable.Cell>{item.tencv}</DataTable.Cell>
                  <DataTable.Cell>{item.ghichu}</DataTable.Cell>
                  <DataTable.Cell>
                    {approveRight[item.quyenduyet]}
                  </DataTable.Cell>
                  <DataTable.Cell
                    style={{
                      flexDirection: "row",
                  ...
                  >
                    ...
                    <TouchableOpacity
                      style={styles.button}
                      onPress={() => toggleToDelete(item.maCV)}
                    >
