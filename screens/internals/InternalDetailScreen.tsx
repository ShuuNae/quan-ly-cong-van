...
import InternalDetail from "../../components/internals/InternalDetail";
...
const InternalDetailScreen = (props: IProps) => {
...
export default InternalDetailScreen;
